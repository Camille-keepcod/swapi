    ...
    public static Spaceships mapper(Map<String, Object> map) {
        try {
            return new Spaceships(
                    ...
                    String.valueOf(map.get("hyperdrive_rating")),
                    String.valueOf(map.get("MGLT")),
                    String.valueOf(map.get("starship_class")),
